[![Build Status](https://dev.azure.com/nrravi98/myFirstProject/_apis/build/status/ravinr98.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/nrravi98/myFirstProject/_build/latest?definitionId=1&branchName=master)
